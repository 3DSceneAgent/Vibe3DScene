...
def build_agent_state_graph(
    *,
    ...
    blocked_recovery_node: Callable[..., Any],
    blocked_recovery_action_node: Callable[..., Any],
    ...
    route_after_blocked_recovery_action: Callable[..., Any],
) -> StateGraph:
    ...
    builder.add_conditional_edges(
        ...
        route_after_blocked_recovery_action,
    )
